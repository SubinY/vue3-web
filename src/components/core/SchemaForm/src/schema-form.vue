    ...
    <Row v-bind="getRowConfig">
      ...
      <slot>
        <template v-for="schemaItem in formSchemasRef" :key="schemaItem.field">
          <SchemaFormItem v-model:form-model="formModel" :schema="schemaItem" :table-instance="tableInstance">
...
<script setup name="SchemaForm">
import { useAttrs, defineProps, defineEmits, defineExpose } from 'vue'
import { pick } from 'lodash-es'
import { Form, Row } from 'ant-design-vue'
import SchemaFormItem from './schema-form-item.vue'
import FormAction from './components/form-action.vue'
import { createFormContext, useFormState, useFormEvents, useFormMethods, useAdvanced } from './hooks/'
...
const { formModel, getRowConfig, schemaFormRef, getFormProps, getFormActionBindProps, formSchemasRef } = formState
