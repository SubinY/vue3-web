...
<script setup name="SchemaFormItem">
import { computed, unref, toRefs, isVNode, onMounted, watch, nextTick, defineProps, defineEmits } from 'vue'
...
const vnodeFactory = (component, values = unref(getValues)) => {
