    ...
    >
      <template #title>
        <div class="popover-title">
          ...
          <Checkbox v-model:checked="checkBordered" @change="handleBorderedCheckChange"> 边框 </Checkbox> -->
          ...
          <template v-for="item in tableColumns" :key="table.getColumnKey(item)">
            <div class="check-item">
              <div style="padding: 4px 16px 8px 0">
                ...
                <!-- <Checkbox v-model:checked="item.hideInTable" :true-value="false" :false-value="true">
                  {{ item.title }}
                </Checkbox> -->
              </div>
...
import { SettingOutlined, VerticalRightOutlined, VerticalLeftOutlined, DragOutlined } from '@ant-design/icons-vue'
...
const handleColumnFixed = (columItem, direction) => {
