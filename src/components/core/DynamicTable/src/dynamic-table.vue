...
import { useSlots, defineProps, defineEmits, defineExpose } from 'vue'
...
const { tableRef, tableData, queryFormRef, editTableFormRef, getBindValues, editFormModel } = tableState
// 表格内部方法
const tableMethods = useTableMethods({ state: tableState, props, emit })
const { setProps, fetchData, handleSubmit, reload, handleTableChange, handleEditFormValidate } = tableMethods
// 控制编辑行
